...
class UNet(nn.Module):
    def __init__(self, n_channels, n_classes, width_multiplier=1, trilinear=True, use_ds_conv=False):
        ...
        self.up1_fusion = Up(896, self.channels[3] // factor, trilinear)
        self.up2_fusion = Up(256, self.channels[2] // factor, trilinear)
        self.up3_fusion = Up(128, self.channels[1] // factor, trilinear)
        self.up4_fusion = Up(64, self.channels[0] , trilinear)
