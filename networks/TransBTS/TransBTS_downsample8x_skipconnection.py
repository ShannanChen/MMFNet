...
def TransBTS(dataset='feta', _conv_repr=True, _pe_type="learned"):
...
if __name__ == '__main__':
    with torch.no_grad():
        ...
        # x = torch.rand((2, 1, 64, 64, 64), device=cuda0)
        input_tensor = torch.rand(1, 1, 1, 64, 64, 64)
        _, model = TransBTS(dataset='feta', _conv_repr=True, _pe_type="learned")
