...
def data_loader(args):
    ...
    if args.mode == 'train':
        ...
        train_samples['T1'] = train_img_T1
        train_samples['T2'] = train_img_T2
        #train_samples['images_adc'] = train_img_adc
        ...
        valid_samples['T1'] = valid_img_T1
        valid_samples['T2'] = valid_img_T2
        ...
        test_samples['T1'] = test_img_T1
        test_samples['T2'] = test_img_T2
    ...
    if dataset == 'feta':
        if args.mode == 'train':
            ...
            train_transforms = Compose(
                [
                    LoadImaged(keys=["image", "T1", "T2", "images_flair", "label"]),
                    AddChanneld(keys=["image", "T1", "T2", "images_flair", "label"]),
                    # AsChannelFirstd(keys="image"),
                    Orientationd(keys=["image", "T1", "T2", "images_flair", "label"], axcodes="RAS"),
                    # ScaleIntensityRanged(
                    #     keys=["image", "images_adc", "images_flair"], a_min=-10, a_max=10,
                    #     b_min=0.0, b_max=1.0, clip=True,
                    # ),
                    # Resized(keys=['image', 'label'], spatial_size=(112, 112, 112)),
                    CropForegroundd(keys=["image", "T1", "T2", "images_flair", "label"], source_key="image"),
                    ...
                    # ),
                    RandSpatialCropSamplesd(
                        keys=["image", "T1", "T2", "images_flair", "label"],
                        roi_size=(64, 64, 64),
                        num_samples=crop_samples,
                        random_size=False,
                    ),
                    RandShiftIntensityd(
                        keys=["image", "T1", "T2", "images_flair"],
                        offsets=0.10,
                        prob=0.50,
                    ),
                    RandAffined(
                    ...
                    ToTensord(keys=["image", "T1", "T2", "images_flair", "label"]),
                ]
            )
            ...
            test_transforms = Compose(
                [
                    LoadImaged(keys=["image", "T1", "T2", "images_flair"]),
                    AddChanneld(keys=["image", "T1", "T2", "images_flair"]),
                    Orientationd(keys=["image", "T1", "T2", "images_flair"], axcodes="RAS"),
                    # ScaleIntensityRanged(
                    #     keys=["image", "images_adc", "images_flair"], a_min=0, a_max=1000,
                    #     b_min=0.0, b_max=1.0, clip=True,
                    # ),
                    CropForegroundd(keys=["image", "T1", "T2", "images_flair"], source_key="image"),
                    ToTensord(keys=["image", "T1", "T2", "images_flair"]),
                ]
            )
